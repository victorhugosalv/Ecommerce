...
public class ParticipanteService {
    ...
    public List<Participante> listarParticipantesPorCategoria(CategoriaParticipante categoriaParticipante) {
        ...
        try (HttpClient client = HttpClient.newHttpClient()) {
            ...
            logger.error("Erro de conexão ao recuperar participantes: {}", ce.getMessage());
            throw new RuntimeException("Erro de conexão ao recuperar participantes: " + ce.getMessage(), ce);
        }catch (Exception e) {
